<!-- LEGACY - DO NOT USE / ADAPTER_SPECIFIC (Reconciliation Directive, 2026-07-14).
     ...
     adapter reference only. See ~/dev/gorp/reference/history/DOCUMENTATION-AUTHORITY-MAP.md and
     ~/dev/gorp/ROADMAP.md §9. -->
---
name: robo
