...
Current capabilities and constraints of Agent OS CLI.
...
|-----------|---------------|-----------|
| `agent-os robo` (dry-run) | Phase 3 | Requires dependency data for safe promotion recommendations |
| `agent-os robo --apply` | Phase 3+ | Mutation authority requires human opt-in and audit logging |
